...
class SyncStates extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class EventSeries extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EventSeries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  EventSeries createAlias(String alias) {
    return EventSeries(attachedDatabase, alias);
  }
...
class EventSeriesContacts extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EventSeriesContacts(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> seriesId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES event_series(id)',
  );
  late final GeneratedColumn<String> contactId = GeneratedColumn<String>(
    'contact_id',
    aliasedName,
  ...
  @override
  EventSeriesContacts createAlias(String alias) {
    return EventSeriesContacts(attachedDatabase, alias);
  }
...
class Events extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> seriesId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NULL REFERENCES event_series(id)',
  );
  ...
  late final GeneratedColumn<int> recurrenceException = GeneratedColumn<int>(
    'recurrence_exception',
    aliasedName,
    true,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NULL DEFAULT 0 CHECK (recurrence_exception IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> recurrenceSuppressed = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NULL DEFAULT 0 CHECK (recurrence_suppressed IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  @override
  List<GeneratedColumn> get $columns => [
...
class TaskSeries extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TaskSeries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> repeatAnchor = GeneratedColumn<String>(
    'repeat_anchor',
    aliasedName,
    false,
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'schedule\'',
    defaultValue: const CustomExpression('\'schedule\''),
  );
  @override
  List<GeneratedColumn> get $columns => [
    id,
  ...
  @override
  TaskSeries createAlias(String alias) {
    return TaskSeries(attachedDatabase, alias);
  }
...
class Tasks extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> taskSeriesId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NULL REFERENCES task_series(id)',
  );
...
class DatabaseAtV8 extends GeneratedDatabase {
  ...
  late final EventSeries eventSeries = EventSeries(this);
  late final EventSeriesContacts eventSeriesContacts = EventSeriesContacts(
    this,
  );
  late final Events events = Events(this);
  late final EventContacts eventContacts = EventContacts(this);
  late final TaskSeries taskSeries = TaskSeries(this);
